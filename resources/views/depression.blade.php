...
@section('content')
                    ...
                    <div class="card-body">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                  <b>Description:</b> The bars to the left show the percentage of 8th and 10th graders in the study who indicated they felt life was often meaningless.<br /><br />
                                  <b>Directions:</b> Use the grouping options to see the prevalence of these feelings by different groups and subgroups.
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-body">
              <div class="container">
                <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          <div class="slidecontainer">
                            <input type="range" min="1" max="9" value="1" class="slider" id="range">
                          </div>
                        </div>
                        <div class="col-md-2" style="text-align: left">9</div>
                      </div>
                      <div class="row">
                  ...
                  <div class="col-md-6">
                    <b>Description:</b> The statistical output here reflects the effect of various predictors for whether or not a student often feels that life is meaningless.  This is a logistic model, where Exp(B) represents the relative likelihood of a student feeling life is often meaningless based on the given factor.<br /><br />
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Depression Proxy Prevalence of 8th & 10th Graders',
          titleTextStyle: {
            fontSize: '15',
            bold: false,
            fontName: 'Nunito'
        ...
        var basicData = google.visualization.arrayToDataTable([
          ['', ''],
          ['', <?=$demographics['basic'][0]['depression']?>]
        ]);
        formatter.format(basicData, 1); // format column 1

        var genderData = google.visualization.arrayToDataTable([
          ['Gender', ''],
          ['Male', <?=$demographics['gender'][0]['depression']?>],
          ['Female', <?=$demographics['gender'][1]['depression']?>]
        ]);
        ...
        var genderRaceData = google.visualization.arrayToDataTable([
          ...
          ['Male', <?=$demographics['genderRace'][0]['depression']?>,<?=$demographics['genderRace'][1]['depression']?>,<?=$demographics['genderRace'][2]['depression']?>],
          ['Female', <?=$demographics['genderRace'][3]['depression']?>,<?=$demographics['genderRace'][4]['depression']?>,<?=$demographics['genderRace'][5]['depression']?>]
        ]);
        ...
        var raceGenderData = google.visualization.arrayToDataTable([
          ['Race', 'Male', 'Female'],
          ['Black', <?=$demographics['genderRace'][0]['depression']?>,<?=$demographics['genderRace'][3]['depression']?>],
          ['White', <?=$demographics['genderRace'][1]['depression']?>,<?=$demographics['genderRace'][4]['depression']?>],
          ['Hispanic', <?=$demographics['genderRace'][2]['depression']?>,<?=$demographics['genderRace'][5]['depression']?>]
        ]);
        ...
        var genderGradeLevelData = google.visualization.arrayToDataTable([
          ...
          ['Male', <?=$demographics['genderGradeLevel'][0]['depression']?>,<?=$demographics['genderGradeLevel'][1]['depression']?>],
          ['Female', <?=$demographics['genderGradeLevel'][2]['depression']?>,<?=$demographics['genderGradeLevel'][3]['depression']?>]
        ]);
        ...
        var gradeLevelGenderData = google.visualization.arrayToDataTable([
          ['Grade', 'Male', 'Female'],
          ['8th', <?=$demographics['genderGradeLevel'][0]['depression']?>,<?=$demographics['genderGradeLevel'][2]['depression']?>],
          ['10th', <?=$demographics['genderGradeLevel'][1]['depression']?>,<?=$demographics['genderGradeLevel'][3]['depression']?>]
        ]);
        ...
        var raceData = google.visualization.arrayToDataTable([
          ['Race', ''],
          ['Black', <?=$demographics['race'][0]['depression']?>],
          ['White', <?=$demographics['race'][1]['depression']?>],
          ['Hispanic', <?=$demographics['race'][2]['depression']?>]
        ]);
        formatter.format(raceData, 1); // format column 1

        var gradeLevelData = google.visualization.arrayToDataTable([
          ['Grade Level', ''],
          ['8th Grade', <?=$demographics['grade_level'][0]['depression']?>],
          ['10th Grade', <?=$demographics['grade_level'][1]['depression']?>]
        ]);
        ...
        var gradeLevelRaceData = google.visualization.arrayToDataTable([
          ...
          ['8th Grade', <?=$demographics['raceGradeLevel'][0]['depression']?>,<?=$demographics['raceGradeLevel'][2]['depression']?>,<?=$demographics['raceGradeLevel'][4]['depression']?>],
          ['10th Grade', <?=$demographics['raceGradeLevel'][1]['depression']?>,<?=$demographics['raceGradeLevel'][3]['depression']?>,<?=$demographics['raceGradeLevel'][5]['depression']?>]
        ]);
        ...
        var raceGradeLevelData = google.visualization.arrayToDataTable([
          ['Race', '8th', '10th'],
          ['Black', <?=$demographics['raceGradeLevel'][0]['depression']?>,<?=$demographics['raceGradeLevel'][1]['depression']?>],
          ['White', <?=$demographics['raceGradeLevel'][2]['depression']?>,<?=$demographics['raceGradeLevel'][3]['depression']?>],
          ['Hispanic', <?=$demographics['raceGradeLevel'][4]['depression']?>,<?=$demographics['raceGradeLevel'][5]['depression']?>]
        ]);
      ...
      function drawForecastChart<?=$ci?>() {
        ...
        var lineOptions = {
          title: 'Forecast for Depression Proxy Prevalence of 8th & 10th Graders',
          legend: {
            position: 'bottom'
          },
        };
