          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                      <center><iframe width="557" height="368" src="https://www.youtube.com/embed/Xzqffm43SHQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></center>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <img src="<?=asset('images/ICPSR-Blue-Logo.jpg')?>" align="right" />The following study is based on survey data of 8th and 10th grade students by the University of Michigan's Inter-university Consortium for Political and Social Research (ICPSR).
                                    ...
                                    To be sure, the results presented here should be carefully scrutinized by educational professionals, and utilized appropriately and in context.  Early intervention is key to redirecting students to postive
                                    pathways, instead of grouping them after the fact.  These data should not be used to label or exclude groups of students, but rather to add additional data to help inform the potential need for care, as part
                                    of a <a href="https://www.edweek.org/ew/articles/2016/12/14/what-are-multitiered-systems-of-supports.html/" target="_blank">Multi-Tiered System of Supports</a>.
                                    <br /><br />
